 ...
 * @author: xrds
 *
 * @create: 2020-07-05 08:59
 **/
public class Session implements Serializable {

  private static final long serialVersionUID = -4506030867581043585L;
  ...
  public  boolean write(Object msg) {
    ...
    if(session!=null&&isConnected())
    {
      ...
      try{
        CabinetMsgProto.CabinetMsg msgModel = (CabinetMsgProto.CabinetMsg)msg;
